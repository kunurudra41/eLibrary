...
<form action="search" method="GET">
            <div id="searchbox">
            <a class="backlink" href="/"><b> &#8592; Back</b></a>
...
$Queryit = $_GET['searchhere'];
    $searchQuery= "%".$Queryit."%";
    $query = "SELECT * FROM books WHERE name LIKE '$searchQuery'  OR Slno LIKE '$searchQuery' OR author LIKE '$searchQuery'";
...
$bookslno=$row['Slno']; 
         ...
         echo ' <div class="ebooks">
            ...
            <a href="'.$booklink.'"
              ...
              <form action="read_later" method="post"><button type="submit" class="bookbutton" name="bookname" value="'.$bookname.'">Read later</button></form></div>
          </div> ';
     }   
     }
     else{
         ...
         <center>
                ...
                <div class="request-body" style="font-size: 2.7vmin;"><b style="font-size: 7vmin;">Not available !</b><br>
                    ...
                    <br><br>
                    <center><a class="view-request" href="request">Request</a></center></div>';
     }
?>
</center>
</body>
